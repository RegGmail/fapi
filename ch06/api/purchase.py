...
print (">>> [API Purchase FastAPI] 1 ---> FastAPI")
...
print (" API Router 1.a) --->[api_router_create_db_connection]")
router.add_event_handler("startup", create_db_connection)
print ("--->[api_router_close_db_connection]")
